...
public class MyLocation implements GoogleApiClient.ConnectionCallbacks,
    ...
    public MyLocation(Context context, double lat, double lng) {
        this.lat = lat;
        this.lng = lng;
        mContext = context;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (mCurrentLocation == null) {
            ...
            if (mCurrentLocation != null) {
                this.setLat(mCurrentLocation.getLatitude());
                this.setLng(mCurrentLocation.getLongitude());
    ...
    protected void stopLocationUpdates() {
        ...
        // The final argument to {@code requestLocationUpdates()} is a LocationListener
        // (http://developer.android.com/reference/com/google/android/gms/location/LocationListener.html).
        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, (LocationListener) mContext);
    }
}
